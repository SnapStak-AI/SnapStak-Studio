...
export class DatabaseSchemaViewProvider implements vscode.WebviewViewProvider {

  public static readonly viewId = 'snapstak.databaseSchemaView';
  private _view?: vscode.WebviewView;

  // Shared schema state — exposed so PrefsView can read it
  private _schema: any = { databases: [] };

  constructor(private readonly context: vscode.ExtensionContext) {}

  // Called by PrefsView to get current schema
  getSchema(): any { return this._schema; }
