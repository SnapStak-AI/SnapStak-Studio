...
import { DatabaseSchemaViewProvider } from './databaseSchemaViewProvider';

export class DatabasePrefsViewProvider implements vscode.WebviewViewProvider {

  public static readonly viewId = 'snapstak.databasePrefsView';
  private _view?: vscode.WebviewView;

  constructor(
    private readonly context: vscode.ExtensionContext,
    private readonly schemaProvider: DatabaseSchemaViewProvider
  ) {}

  // Called externally to push staks (from canvas/editor)
  setStakElements(elements: any[]): void {
