...
export class SettingsViewProvider implements vscode.WebviewViewProvider {
  ...
  public static readonly viewId = 'snapstak.settingsView';
  private _view?: vscode.WebviewView;

  constructor(
    private readonly context: vscode.ExtensionContext,
    private readonly onFolderChanged: (folderPath: string | null) => void
  ) {}
  ...
  static readonly FOLDER_KEY = 'snapstak.workspaceFolder';

  getStoredFolder(): string | undefined {
    return this.context.globalState.get<string>(SettingsViewProvider.FOLDER_KEY);
  }

  private async saveFolder(folderPath: string | null): Promise<void> {
    if (folderPath) {
  ...
  private getHtml(currentFolder?: string): string {
