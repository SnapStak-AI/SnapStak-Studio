...
import { WorkspacesViewProvider } from './workspacesViewProvider';
...
export class ZipItem extends vscode.TreeItem {

  public readonly isExtracted: boolean;
  ...
  private getFileSizeLabel(filePath: string): string {
    try {
...
export class ZipMessageItem extends vscode.TreeItem {
...
export class ZipViewProvider implements vscode.TreeDataProvider<vscode.TreeItem> {

  public static readonly viewId = 'snapstak.zipView';
  ...
  constructor(
    private readonly workspacesProvider: WorkspacesViewProvider,
    private readonly client?: SnapStakClient
  ) {}
  ...
  async openExtracted(extractedPath: string): Promise<void> {
    ...
    vscode.commands.executeCommand(`${WorkspacesViewProvider.viewId}.focus`);
  }
  ...
  private findProjectRoot(dir: string): string | null {
...
export class ZipItemDecorationProvider implements vscode.FileDecorationProvider {
